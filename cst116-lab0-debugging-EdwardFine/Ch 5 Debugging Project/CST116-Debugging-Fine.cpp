...
* next.
*
* CST 116, Edward Fine, Lab0, debugging
* 
...
*    looking code?
* So far, all I can see is that the money has been assigned its value of 123.45
* and in the console it simply says "You have $". I don't see any messy code
* after stepping into cout<<money<<endl;.
...
* The money went to 12.3450003, by making the raise get the addition to the
* money and then adding it to the total money, it will give the correct value 
* of money with the raise.
*
...
int main()
{
    ...
    cout << "Enter percent raise (in decimal form): ";
    cin >> raise;
    raise = raise * money;
    money = money + raise;
